...
# Classe para detectar reentrância
class ReentrancyDetector():
    ...
    def detect_reentrancy(self, tainted_record, current_instruction, transaction_index):
        ...
        # Lembrar chamadas com mais de 2300 gas e onde o valor é maior que zero
        ...
        # Verificar se este sstore está acontecendo após uma chamada
